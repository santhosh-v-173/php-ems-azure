                        ...
                        $id = $_GET['e_id'];
                          ...
                          if(mysqli_num_rows($result) > 0 ){
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control input-sm" name="e_name" value = "<?php echo $employee['e_name'];?>" required>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control input-sm" name="e_email" value = "<?php echo $employee['e_email'];?>" required>
                            </div>
                            <div class="form-group">
                                <input type="tel" class="form-control input-sm" name="e_phone" value = "<?php echo $employee['e_phone'];?>" required>
                            </div>
                            <div class="form-group">
